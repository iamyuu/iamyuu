import { useSSRContext, defineComponent, getCurrentInstance, useSlots, computed, h } from 'vue';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxtjs+mdc@0.2.2_rollup@3.29.4/node_modules/@nuxtjs/mdc/dist/runtime/components/MDCSlot.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_0 = _sfc_main;

export { __nuxt_component_0 as _, flatUnwrap as f, unwrap as u };
//# sourceMappingURL=MDCSlot-6377ba4e.mjs.map
