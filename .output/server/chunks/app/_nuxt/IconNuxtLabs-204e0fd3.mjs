...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt-themes+elements@0.9.5_postcss@8.4.31_rollup@3.29.4_vue@3.3.4/node_modules/@nuxt-themes/elements/components/icons/IconNuxtLabs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const IconNuxtLabs = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { IconNuxtLabs as default };
//# sourceMappingURL=IconNuxtLabs-204e0fd3.mjs.map
